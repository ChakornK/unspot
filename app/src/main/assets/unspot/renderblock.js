(() => {
  ...
  if (!isLoginPage) {
    ...
    window.IntersectionObserver = () => ({ observe: () => {}, unobserve: () => {}, disconnect: () => {}, takeRecords: () => [], root: null, rootMargin: "", thresholds: [] });
    window.ResizeObserver = () => ({ observe: () => {}, unobserve: () => {}, disconnect: () => {} });
